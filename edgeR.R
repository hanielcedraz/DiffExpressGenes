...
pdf("MDS-any_information.pdf") #create a PDF with MDS plot. You can change the file name
...
pdf("mean.variance-any_information.pdf") #create a PDF with mean.variance plot. You can change the file name
...
pdf("smear-any_information.pdf") #create a PDF with smear plot. You can change the file name
...
# Plotting heatmap:
png("heatmap_.png",    # create PNG for the heat map. You can change the file name      
